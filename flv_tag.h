...
{
public:
	FlvTag() : tag_buffer(NULL), tag_reader(NULL), dup_reader(NULL), des_buffer(NULL), des_reader(NULL),head_buffer(NULL), head_reader(NULL),
...
public:
    ...
    bool is_init_current_handler;//如果是flv 格式的话，需要初始化一次
};
